                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23"
                                      ...
                                      ?>
                                        <tr>
                                             <?php
                                            $resultaa = $achatC->affichernomprenom($row["id_utilisateur"]);
                                        ...
                                        foreach($listprod as $row3){
                                            ?>
                                            <td><?php echo $row3['nom']; ?></td>
                                            <td><img src="<?php echo $row3['image']; ?>" heigth="200" width=150></td>
                                            <?php
                                        }
                                        ?>
                                            <td>
                                               <form method="POST" action="supprimerAchat.php">
